...
echo "Agent 1 sends ${amountToSend} to ${recipient} & gets back ${change} in change address ${changeAddress}"


rawtxhex=`docker exec test_1 blackmore-cli createrawtransaction '''[ { "txid": "'${utxo_txid_1}'", "vout": '${utxo_vout_1}' }, { "txid": "'${utxo_txid_2}'", "vout": '${utxo_vout_2}' } ]''' '''{ "'$recipient'": "'${amountToSend}'", "'$changeAddress'": "'${change}'" }'''`
