...
for run in {1..120}; do
    ...
    docker exec blk_2 blackmore-cli generatetoaddress 1 ${address2} &
    docker exec blk_3 blackmore-cli generatetoaddress 1 ${address3} &
    docker exec blk_4 blackmore-cli generatetoaddress 1 ${address4} &
    docker exec blk_5 blackmore-cli generatetoaddress 1 ${address5} &
    docker exec blk_6 blackmore-cli generatetoaddress 1 ${address6} &
    docker exec blk_7 blackmore-cli generatetoaddress 1 ${address7} &
    docker exec blk_8 blackmore-cli generatetoaddress 1 ${address8} &
    docker exec blk_9 blackmore-cli generatetoaddress 1 ${address9} &
    docker exec blk_10 blackmore-cli generatetoaddress 1 ${address10} &
    docker exec blk_11 blackmore-cli generatetoaddress 1 ${address11} &
    docker exec blk_12 blackmore-cli generatetoaddress 1 ${address12} &
    docker exec blk_13 blackmore-cli generatetoaddress 1 ${address13} &
    docker exec blk_14 blackmore-cli generatetoaddress 1 ${address14} &
    docker exec blk_15 blackmore-cli generatetoaddress 1 ${address15} &
    wait
done
